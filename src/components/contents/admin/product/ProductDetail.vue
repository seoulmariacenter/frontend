  ...
  <div class="col-lg-9 col-md-8 bg-light">
    <div class="m-3">
      ...
      <div class="row m-2 d-flex justify-content-between">
        <router-link :to="{name: 'Schedule'}" tag="button" class="col-3 btn btn-lg btn-outline-warning">일정표 관리</router-link>
        <router-link :to="{name: 'AdminReservationList'}" tag="button" class="col-3 btn btn-lg btn-outline-primary ml-1">예약 확인</router-link>
      </div>
    </div>
  </div>
</template>
